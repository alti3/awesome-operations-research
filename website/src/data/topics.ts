...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    description:
      "MILP and MIP unlock facility location, product allocation, routing, scheduling, and unit commitment when some decisions must be binary or integer. Branch-and-bound, cutting planes, and column generation tame combinatorial complexity.",
    concepts: [
      "Binary variables",
      "Sets and parameters",
      "Branch & bound",
  ...
  },
  {
    ...
    description:
      "NLP covers optimization models with nonlinear objectives or constraints, including smooth continuous NLP, QP, QCQP, SOCP, and nonconvex global optimization cases.",
    concepts: [
  ...
  },
  {
    ...
    regionIndex: 2,
    topicIndex: 7,
    title: "Second-Order Cone Programming (SOCP - Beta)",
    short: "A convex nonlinear model class inside conic optimization.",
    description:
      "SOCP models linear objectives with affine and second-order cone constraints, covering norms, robust linear constraints, portfolio risk, and many convex quadratic patterns.",
    concepts: [
      "Second-order cones",
      "Conic programming",
  ...
  },
  {
    ...
    short: "Linear constraints with a quadratic objective function.",
    description:
      "QP optimizes a quadratic objective over linear constraints. Convex QP is a dependable bridge between LP and NLP; nonconvex QP belongs closer to global optimization.",
    concepts: [
  ...
  {
    id: "quadratically-constrained-quadratic-programming",
    region: "optimization-core",
    regionIndex: 2,
    topicIndex: 16,
    title: "Quadratically Constrained Quadratic Programming (QCQP - Beta)",
    short: "Quadratic objectives with quadratic constraints.",
    description:
      "QCQP extends QP by allowing quadratic constraints. Convex QCQP is tractable with conic or interior-point methods; nonconvex QCQP often needs relaxations, bounds, or global optimization.",
    concepts: [
    ...
    applications: ["Portfolio risk", "Signal processing", "Robust optimization", "Power systems"],
    difficulty: "Advanced",
    type: "Method",
    resources: [
      {
      ...
      { title: "QPLIB", url: "https://qplib.zib.de/" },
    ],
    next: [
      "least-squares-quadratic-optimization",
      "conic-semidefinite-optimization",
